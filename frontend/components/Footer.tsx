        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">OmniAgentOS</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/upload" className="text-slate-400 hover:text-white text-sm transition-colors">
                  Upload Files
                </Link>
              </li>
              <li>
                <Link href="/health" className="text-slate-400 hover:text-white text-sm transition-colors">
                  System Health
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-slate-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-slate-400 text-sm">
              © 2024 OmniAgentOS. All rights reserved.
            </p>
          </div>
        </div>
      </div>
